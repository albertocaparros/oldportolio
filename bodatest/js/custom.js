(function() {
    ...
    simplyCountdown('date-countdown', {
		year: 2019, // required
		month: 9, // required
		day: 28, // required
		...
		sectionClass: 'probootstrap-wedding-countdown', //section css class
		amountClass: 'probootstrap-animate', // amount css class
		wordClass: 'date-countdown', // word css class
		zeroPad: false,
